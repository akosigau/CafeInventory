...
import JuanLogo from '../images/logo.png'
  ...
  return (
    <div>
      ...
      <div
        ...
        -900 bg-opacity-30 z-40 lg:hidden lg:z-auto transition-opacity duration-200 ${
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <img className="w-full" src={JuanLogo} alt="User" />
          </NavLink>
        </div>
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-700 truncate transition duration-150 ${
                      ...
                      >
                        <div className="flex items-center justify-between">
                            ...
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <path
                                className={`fill-current ${
                                  pathname === '/' || pathname.includes('dashboard') ? 'text-yellow-800' : 'text-slate-400'
                                }`}
                                d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0z"
                              />
                              <path
                                className={`fill-current ${
                                  pathname === '/' || pathname.includes('dashboard') ? 'text-yellow-900' : 'text-slate-600'
                                }`}
                                d="M12 3c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9z"
                              />
                              <path
                                className={`fill-current ${
                                  pathname === '/' || pathname.includes('dashboard') ? 'text-yellow-700' : 'text-slate-400'
                                }`}
                          ...
                          <div className="flex shrink-0 ml-2">
                            <svg className={`w-3 h-3 shrink-0 ml-1 fill-current text-slate-800 ${open && 'rotate-180'}`} viewBox="0 0 12 12">
                        ...
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/"
                              className={({ isActive }) =>
                                'block transition duration-150 truncate ' + (isActive ? 'text-yellow-800' : 'text-slate-400 hover:text-slate-200')
                              }
                            >
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              className={({ isActive }) =>
                                'block transition duration-150 truncate ' + (isActive ? 'text-yellow-800' : 'text-slate-600 hover:text-slate-200')
                              }
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Analytics
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              className={({ isActive }) =>
                                'block transition duration-150 truncate ' + (isActive ? 'text-indigo-500' : 'text-slate-600 hover:text-slate-200')
                              }
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Fintech
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-shrink-0 ml-2">
                      <span className="inline-flex items-center justify-center h-5 text-xs font-medium text-white bg-yellow-900 px-2 rounded">4</span>
                    </div>
                  </div>
                </NavLink>
              </li>
