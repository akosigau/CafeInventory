...
function DashboardCard07() {
  return (
    <div className="col-span-full xl:col-span-8 bg-slate-300 shadow-lg rounded-sm border border-slate-200">
      ...
      <div className="p-3">
        ...
        <div className="overflow-x-auto">
          <table className="table-auto w-full">
            {/* Table header */}
            <thead className="text-xs uppercase text-slate-400 bg-slate-300 rounded-sm">
              <tr>
                <th className="p-2">
