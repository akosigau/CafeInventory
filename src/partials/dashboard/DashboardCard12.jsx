...
function DashboardCard12() {
  return (
    <div className="col-span-full xl:col-span-6 bg-slate-300 shadow-lg rounded-sm border border-slate-200">
      ...
      <div className="p-3">
        ...
        {/* "Today" group */}
        <div>
          <header className="text-xs uppercase text-slate-400 bg-slate-30 rounded-sm font-semibold p-2">Today</header>
          <ul className="my-1">
            {/* Item */}
        ...
        {/* "Yesterday" group */}
        <div>
          <header className="text-xs uppercase text-slate-400 bg-slate-300 rounded-sm font-semibold p-2">Yesterday</header>
          <ul className="my-1">
            {/* Item */}
            <li className="flex px-2">
