...
function FilterButton() {
  ...
  return (
    <div className="relative inline-flex ">
      <button
        ref={trigger}
        className="btn bg-slate-300 border-slate-200 hover:border-slate-300 text-slate-500 hover:text-slate-600"
        aria-haspopup="true"
      ...
      <Transition
        show={dropdownOpen}
        tag="div"
        className="origin-top-right z-10 absolute top-full left-0 right-auto md:left-auto md:right-0 min-w-56 bg-slate-300 border border-slate-200 pt-1.5 rounded shadow-lg overflow-hidden mt-1"
      ...
      >
        <div ref={dropdown}>
          ...
          <div className="py-2 px-3 border-t border-slate-200 bg-slate-300">
            <ul className="flex items-center justify-between">
              ...
              <li>
                <button className="btn-xs bg-slate-500 hover:bg-slate-600 text-white" onClick={() => setDropdownOpen(false)} onBlur={() => setDropdownOpen(false)}>Apply</button>
              </li>
            </ul>
          </div>
        </div>
